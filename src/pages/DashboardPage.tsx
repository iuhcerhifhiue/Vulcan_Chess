...
import { Pattern } from '../../utils/patternAnalyzer'; // Adjust path as needed
import { Lesson } from '../../utils/lessonGenerator'; // Adjust path as needed
...
interface StatEntry {
  ...
  // Add more properties as observed from Chess.com API
}

interface Stats {
  chess_bullet?: StatEntry;
  chess_blitz?: StatEntry;
  chess_rapid?: StatEntry;
  chess_daily?: StatEntry;
...
interface UserProfileData {
  ...
  stats: Stats;
  patterns: Pattern[];
  // Add other top-level user profile properties if they exist
}
...
const DashboardPage: React.FC<DashboardPageProps> = ({ userProfile, lessons, onStartLesson, onBack }) => {
